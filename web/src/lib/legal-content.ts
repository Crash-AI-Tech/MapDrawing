...
export const LEGAL_COPY: Record<'terms' | 'privacy', Record<Lang, LegalDocumentCopy>> = {
  terms: {
    zh: {
      title: '服务条款', updated: '生效日期：2026 年 7 月 20 日', summary: '本条款适用于 DrawMaps Web 网站、iOS 应用及相关服务。创建账号或使用服务即表示你同意本条款。',
      sections: [
        { title: '1. 服务与账号', paragraphs: [`DrawMaps 由 ${operatorZh} 运营，提供在共享地图上绘画、放置图钉、留言和浏览他人内容的服务。`, '你必须年满 13 岁，并为账号资料与凭据安全负责。不得代表他人创建账号或提供虚假信息。'] },
        ...
        { title: '8. 联系方式', paragraphs: [`运营主体：${operatorZh}；联系人：温建；条款问题请联系 ${contact}。本条款受运营者所在地适用法律管辖，不影响你依强制性消费者保护法享有的权利。`] },
      ],
    },
    en: {
      title: 'Terms of Service', updated: 'Effective: July 20, 2026', summary: 'These terms apply to the DrawMaps website, iOS app, and related services. By creating an account or using DrawMaps, you agree to them.',
      sections: [
        { title: '1. Service and accounts', paragraphs: [`DrawMaps is operated by ${operatorEn} and provides a shared map on which users can draw, place pins, leave messages, and view public creations.`, 'You must be at least 13 and are responsible for accurate account information and the security of your credentials. Do not create an account for someone else or misrepresent your identity.'] },
        ...
        { title: '8. Contact and governing law', paragraphs: [`Operator: ${operatorEn}; contact person: Wen Jian; questions may be sent to ${contact}. These terms are governed by the law applicable where the operator is established, without limiting mandatory consumer rights that apply to you.`] },
      ],
    },
    ja: {
      title: '利用規約', updated: '2026 年 7 月 20 日施行', summary: '本規約は DrawMaps の Web サイト、iOS アプリおよび関連サービスに適用されます。',
      sections: [
        { title: '1. サービスとアカウント', paragraphs: [`DrawMaps は ${operatorJa} が運営し、共有地図上での描画、ピン、メッセージ、公開作品の閲覧を提供します。`, '利用者は 13 歳以上で、正確な情報と認証情報の管理に責任を負います。'] },
        ...
        { title: '8. 連絡先', paragraphs: [`運営者：${operatorJa}、担当者：温建。ご質問は ${contact} まで。本規約は運営者所在地の適用法に従い、利用者の強行的な消費者権利を制限しません。`] },
      ],
    },
  },
  privacy: {
    zh: {
      ...
      sections: [
        ...
        { title: '7. 联系与变更', paragraphs: [`个人信息处理者：${operatorZh}；联系人：温建；隐私问题或权利请求请联系 ${contact}。为保护账号，我们可能要求验证身份。`, '我们可能更新本政策，并在页面标明新的生效日期。重大变更将通过服务或其他合理方式通知。'] },
      ],
    },
    en: {
      ...
      sections: [
        ...
        { title: '7. Contact and changes', paragraphs: [`Data controller: ${operatorEn}; contact person: Wen Jian. For privacy questions or rights requests, contact ${contact}. We may verify identity to protect the account.`, 'We may update this policy and will show a new effective date. Material changes will be announced through the service or another reasonable channel.'] },
      ],
    },
    ja: {
      ...
      sections: [
        ...
        { title: '7. 連絡先と変更', paragraphs: [`データ管理者：${operatorJa}、担当者：温建。プライバシーに関するご質問・権利請求は ${contact} まで。アカウント保護のため本人確認を求める場合があります。`, 'ポリシーを変更する場合は新しい施行日を表示し、重要な変更を合理的な方法で通知します。'] },
      ],
    },
  },
};
