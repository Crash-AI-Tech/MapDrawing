...
const t = {
  zh: {
    ...
    heroTitle1: '在真实地图上，',
    heroTitle2: '和全世界一起涂鸦',
    heroDesc: '把回忆画在发生的地方，给喜欢的街角留一句话。先试画，再邀请朋友来到同一个坐标，让一张地图慢慢长出你们的故事。',
    heroCta: '开始探索 ',
    // features
    featTitle: '玩法介绍',
    featSubtitle: '一幅小画、一句问候、一次共同创作。让熟悉的地方，多一点想象。',
    feat1Title: '无限地图涂鸦',
    ...
    step1Title: '漫游并精确定位',
    step1Desc: '找到想画的街角，点击画笔，我们会帮你放大到合适比例。也可以从北京、巴黎或东京开始探索。',
    step2Title: '定制化艺术工具',
    step2Desc: '从工具栏选择画笔或图钉，并按创作需要调节尺寸、颜色和透明度。再次点击画笔即可切换橡皮擦。',
    step3Title: '留下持久化印记',
    step3Desc: '游客可以先试画，登录后主动发布到公开地图。看到「已保存」后，分享地点链接，邀请朋友接着画。',
    // ink
    inkTitle: '公平透明的墨水系统',
  ...
  en: {
    ...
    featSubtitle: 'A small sketch, a local hello, a shared memory. Make familiar places a little more imaginative.',
    ...
    step1Desc: 'Find a place that matters. Choose Pencil and we will zoom in for you, or start exploring a city from the map guide.',
    ...
    step3Desc: 'Try a sketch before signing in. Publish when you are ready, check that it is saved, then send a place link so a friend can add their mark.',
  ...
  ja: {
    ...
    step1Title: '場所を見つける', step1Desc: '思い出の場所を選びましょう。鉛筆を選ぶと、描きやすい縮尺まで自動で拡大します。',
    step2Title: 'ツールを整える', step2Desc: '鉛筆またはピンを選び、サイズ、色、不透明度を調整します。鉛筆をもう一度押すと消しゴムに切り替わります。',
    step3Title: '作品を残す', step3Desc: 'ログイン前にお試し描画ができます。ログインして公開し、保存を確認したら、場所のリンクで友だちを招待しましょう。',
    inkTitle: '公平で透明なインク',
