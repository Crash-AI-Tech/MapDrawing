...
> Retired on 2026-09-15. The one-time migration/import scripts and the legacy
> databases referenced below have been removed. Keep this document only as a
> historical record; do not run these commands.
